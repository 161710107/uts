...
<body>
  ...
  <h1 align="center"><font color="green">Edit Hasil</h1></font>
  <fieldset style="width: 50%; margin: auto;">
    <legend><font color="green">Form Edit Hasil</legend></font>
    <form action="simpanedithasil.php" method="post">
...
<select class="form-control "
  ...
  <span class="input-group-addon" id="sizing-addon1">nilai_Tpa</span>
        <input type="text" name="TPA" class="form-control" placeholder="nilai_tpa" aria-describedby="sizing-addon1" value="<?php echo $data['nilai_tpa'];?>" required />
        </div>
      </p>
      <p>
        <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Nilai_Wawancara</span>
        <input type="text" name="WW" class="form-control" placeholder="nilai_wawancara" aria-describedby="sizing-addon1" value="<?php echo $data['nilai_wawancara'];?>" required />
        </div>
      </p>
      <p>
     <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Nilai_Uan</span>
        <input type="text" name="uan" class="form-control" placeholder="nilai_uan" aria-describedby="sizing-addon1" value="<?php echo $data['nilai_uan'];?>" required />
        </div>
      </p>
      <p>
        <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Nilai_minat</span>
        <input type="text" name="minat" class="form-control"  placeholder="nilai_minat" aria-describedby="sizing-addon1" value="<?php echo $data['nilai_minat'];?>" required />
        </div>
      </p>
      <p>
      <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Nilai_rata</span>
        <input type="text" name="rata" class="form-control" placeholder="nilai_rata" aria-describedby="sizing-addon1" value="<?php echo $data['nilai_rata'];?>" required />
        </div>
      </p>
      <p>
         <div class="input-group input-group-lg">
...
<select class="form-control "
  ...
  <span class="input-group-addon" id="sizing-addon1">tahun_ajaran</span>
        <input type="text" name="ajaran" class="form-control" placeholder="tahun_ajaran" aria-describedby="sizing-addon1" value="<?php echo $data['tahun_ajaran'];?>" required />
        </div>
      </p>
