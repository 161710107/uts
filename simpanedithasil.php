...
$simpan4 = "UPDATE  hasils SET pendaftar_id= '$pendaftar', jurusan_id='$jurusan', nilai_tpa='$nilai_tpa', nilai_wawancara='$nilai_wawancara', nilai_uan='$nilai_uan', nilai_minat='$nilai_minat', nilai_rata='$hasil', penguji_id='$penguji', tahun_ajaran='$tahun_ajaran', keterangan='$index' Where id='$id'";
