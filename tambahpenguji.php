...
<body>
        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li  class="active"><a href="Lihatdatapenguji.php">penguji</a></li>
    ...
    <h2 align = "center"><font color="magenta">INPUT PENGUJI</h2></font>
<fieldset style ="width: 50%; margin: auto;" >
<legend><font color="magenta">FORM INPUT PENGUJI</legend></font>

<form action ="simpanuji.php" method="post">
<p>
...
<div class="input-group input-group-lg">
  ...
  <input type ="text" name="jabatan" class="form-control" placeholder="jabatan" aria-describedby="sizing-addon1"  required />
  </div>
</p>
<p>
...
<br />
<center><a href ="lihatdatapenguji.php"  class='btn btn-danger' >&Lt;Tabel Biodata</a>
</center>
