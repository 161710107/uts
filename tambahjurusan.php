...
<h2 align = "center"><font color="magenta">INPUT JURUSAN</h2></font>
<fieldset style ="width: 50%; margin: auto;" >
<legend><font color="red">FORM INPUT JURUSAN</legend></font>
...
<div class="input-group input-group-lg">
  ...
  <input type ="text" name="nilai_lulus" class="form-control" placeholder="nilai_lulus" aria-describedby="sizing-addon1"  required />
  </div>
</p>
<p>
...
<br />
<center><a href ="lihatdatajurusan.php" class='btn btn-danger' >&Lt;Tabel Biodata</a>
</center>
