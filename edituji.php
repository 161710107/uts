...
?>
<center><h3><font color="magenta">Edit Data penguji</h3></center></font>
<fieldset style="width: 50%; margin: auto;">
<legend><font color="magenta">Form Edit penguji</legend></font>
<form action="simpanedituji.php" method="post">
...
<div class="input-group input-group-lg">
  ...
  <input type ="text" name="jabatan" class="form-control" value="<?php echo $data['jabatan'];?>" placeholder="jabatan" aria-describedby="sizing-addon1"  required />
  </div>
</p>
<p>
