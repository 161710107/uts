...
?>
<center><h2 align = "center"><font color="brown">EDIT DAFTAR</h2></center></font>
<fieldset style ="width: 50%; margin: auto;" >
<legend><font color="yellow">FORM  EDIT DAFTAR</legend></font>
<form action="simpaneditdaftar.php" method="post">
<input type="hidden" name="id" value="<?php echo $data['id'];?>">
<p>
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Nama</span>
<input type ="text" name="nama" class="form-control"  value="<?php echo $data['nama'];?>" placeholder="nama" aria-describedby="sizing-addon1"  required />
</div>
</p>
<p>
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Tempat_lahir</span>
<input type ="text" name="tempat_lahir" class="form-control" value="<?php echo $data['tempat_lahir'];?>" placeholder="tempat_lahir" aria-describedby="sizing-addon1"  required />
</div>
</p>
<p>
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Tanggal_lahir</span>
<input type ="date" name="tanggal_lahir" class="form-control"  value="<?php echo $data['tanggal_lahir'];?>" placeholder="tanggal_lahir" aria-describedby="sizing-addon1"    required />
</div>
</p>
<p>
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">jenis_kelamin</span>
<select name="jenis_kelamin"  class="form-control"  value="<?php echo $data['jenis_kelamin'];?>"  aria-describedby="sizing-addon1" required />
...
<select name="agama"  class="form-control"  value="<?php echo $data['agama'];?>" aria-describedby="sizing-addon1" required />
<option>islam</option>
...
<input type ="text" name="phone" class="form-control"  value="<?php echo $data['phone'];?>" placeholder="phone" aria-describedby="sizing-addon1"    required />
</div>
</p>
<p>
