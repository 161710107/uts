...
<body>
        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="Lihatdatakepsek.php">kepala sekolah</a></li>
    ...
    </div> <!-- /container --><h2 align = "center"><font color="red"> INPUT KEPSEK</h2></font>
<fieldset style ="width: 50%; margin: auto;" >
<legend><font color="red"> FORM INPUT KEPSEK</legend></font>

<form action ="simpankepsek.php" method="post">
<p>
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Nip</span>
<input type ="text" name="nip" class="form-control" placeholder="nip" aria-describedby="sizing-addon1"  required />
</div>
</p>
<p>
<div class="input-group input-group-lg">
...
<br />
<center><a href ="lihatdatakepsek.php" class='btn btn-danger' >&Lt;Tabel Biodata</a>
</center>
