...
?>
<center><h3><font color="red"> Show Data Kepsek</h3></center></font>
<fieldset style="width: 50%; margin: auto;">
<legend><font color="red"> Show Edit kepsek</legend></font>
<input type="hidden" name="id" value="<?php echo $data['id'];?>">
<<p>
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Nip</span>
<input type ="text" name="nip" class="form-control" value="<?php echo $data['nip'];?>" placeholder="nip" aria-describedby="sizing-addon1"  readonly />
</div>
</p>
<p>
<div class="input-group input-group-lg">
